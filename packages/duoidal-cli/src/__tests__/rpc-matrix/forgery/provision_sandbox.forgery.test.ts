/**
 * Forgery test: provision_sandbox
 *
...
describe('forgery: provision_sandbox — Alice cannot act as Bob', () => {
      ...
      await withTestUser(async (bob) => {
        ...
        const result = await callRpc(
          'provision_sandbox',
          {
            ...
            p_server_name: 'forgery-test-server',
            p_ssh_key_name: 'forgery-key',
            p_public_key: 'ssh-ed25519 AAAA test',
